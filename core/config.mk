...
include vendor/lumine/config/BoardConfigLumine.mk
...
ifneq ($(wildcard device/lumine/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/lumine/sepolicy/common/sepolicy.mk)
endif
...
else ifneq ($(filter vendor/lumine-priv/%,$(DEFAULT_SYSTEM_DEV_CERTIFICATE)),)
